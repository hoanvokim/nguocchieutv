...
class WOO_Slg_Admin {
    ...
    public function woo_slg_admin_menu_pages() {
        ...
        add_menu_page(esc_html__('WooCommerce Social Login', 'wooslg'), esc_html__('WooCommerce Social Login', 'wooslg'), 'manage_options', 'woo-social-login', array($this, 'woo_slg_social_login'), esc_url(WOO_SLG_IMG_URL) . '/wpweb-menu-icon.png');
