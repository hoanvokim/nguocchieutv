						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<p class="description"><label for="woo_slg_delete_options"><?php echo esc_html__( 'If you don\'t want to use the Social Login Plugin on your site anymore, you can check that box. This makes sure, that all the settings and tables are being deleted from the database when you deactivate the plugin.','wooslg' ); ?></label></p>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									...
									<p class="description"><label for="woo_slg_public_js_unique_version"><?php echo esc_html__( 'Check this box, if you use a caching plugin','wooslg' ); ?></label></p>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									<a class="button" href="<?php echo add_query_arg(array( 'woo_slg_gen_sys_log' => '1')); ?>" ><?php echo esc_html__( 'Generate System Report', 'wooslg' ); ?></a>
