				...
				<div class="handlediv" title="<?php esc_html_e( 'Click to toggle', 'wooslg' ); ?>"><br /></div>
					...
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								<th scope="row">
									<label><?php esc_html_e( 'Facebook Application:', 'wooslg' ); ?></label>
								</th>
								<td>
									<p class="description"><?php echo esc_html__( 'Before you can start using Facebook for the social login, you need to create a Facebook Application. You can get a step by step tutorial on how to create Facebook Application on our', 'wooslg' ) . ' <a target="_blank" href="' . esc_url('https://docs.wpwebelite.com/social-network-integration/facebook/') . '">'. esc_html__( 'Documentation', 'wooslg' ). '</a>'; ?></p>
								</td>
							</tr>

							<tr>
								<th scope="row">
									<label for="woo_slg_enable_facebook"><?php esc_html_e( 'Enable Facebook:', 'wooslg' ); ?></label>
								</th>
								<td>
									...
									<label for="woo_slg_enable_facebook"><?php echo esc_html__( 'Check this box, if you want to enable facebook social login registration.', 'wooslg' ); ?></label>
								</td>
							</tr>
							
							<tr valign="top">
								<th scope="row">
									<label for="woo_slg_fb_app_id"><?php esc_html_e( 'Facebook App ID/API Key:', 'wooslg' ); ?></label>
								</th>
								<td>
							...
							<tr valign="top">
								<th scope="row">
									<label for="woo_slg_fb_app_secret"><?php esc_html_e( 'Facebook App Secret:', 'wooslg' ); ?></label>
								</th>
								<td>
							...
							<tr valign="top">
								<th scope="row">
									<label><?php echo esc_html__( 'Facebook Valid OAuth Redirect URL:', 'wooslg' ); ?></label>
								</th>
								<td>
									<span class="description"><?php echo '<code>'.WOO_SLG_FB_REDIRECT_URL.'</code>'; ?></span>
								</td>
							</tr>

							<tr valign="top">
								<th scope="row">
									<label for="woo_slg_fb_language"><?php echo esc_html__( 'Facebook API Locale:', 'wooslg' ); ?></label>
								</th>
								<td>
							...
							<tr>
								<th scope="row">
									<label for="woo_slg_enable_fb_avatar"><?php esc_html_e( 'Enable Facebook Avatar:', 'wooslg' ); ?></label>
								</th>
								<td>
									...
									<label for="woo_slg_enable_fb_avatar"><?php echo esc_html__( 'Check this box, if you want to use Facebook profile pictures as avatars.', 'wooslg' ); ?></label>
								</td>
							</tr>

							<tr valign="top">
								<th scope="row">
									<label for="woo_slg_fb_icon_url"><?php esc_html_e( 'Custom Facebook Icon:', 'wooslg' ); ?></label>
								</th>
								<td>
							...
							<tr valign="top">
								<th scope="row">
									<label for="woo_slg_fb_link_icon_url"><?php esc_html_e( 'Custom Facebook Link Icon:', 'wooslg' ); ?></label>
								</th>
								<td>
							...
							<tr valign="top">
								<th scope="row">
									<label for="woo_slg_fb_icon_text"><?php esc_html_e( 'Custom Facebook Text:', 'wooslg' ); ?></label>
								</th>
								<td>
							...
							<tr valign="top">
								<th scope="row">
									<label for="woo_slg_fb_link_icon_text"><?php esc_html_e( 'Custom Facebook Link Text:', 'wooslg' ); ?></label>
								</th>
								<td>
