 ...
 * @since 1.0.0
 */
global $woo_slg_social_facebook,$woo_slg_social_linkedin,$woo_slg_social_windowslive,
	$woo_slg_social_twitter,$woo_slg_social_yahoo,$woo_slg_social_foursquare,$woo_slg_social_vk,$woo_slg_social_instagram, 
	$woo_slg_social_amazon, $woo_slg_social_paypal,$woo_slg_social_line,$woo_slg_social_apple;
