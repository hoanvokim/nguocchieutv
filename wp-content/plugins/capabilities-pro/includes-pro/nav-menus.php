...
$ppc_other_permissions = ["ppc_users" => __('Logged In Users', 'capsman-enhanced'), "ppc_guest" => __('Logged Out Users', 'capsman-enhanced')];
    ...
    <div class="wrap publishpress-caps-manage pressshack-admin-wrapper pp-capability-menus-wrapper">
        ...
        <script type="text/javascript">
            ...
            jQuery(document).ready(function ($) {
                ...
                // -------------------------------------------------------------
                $('#ppc-nav-menu-form').attr('action', '<?php echo admin_url('admin.php?page=pp-capabilities-nav-menus&role=' . $default_role . ''); ?>');
                ...
                $(document).on('change', '.pp-capability-menus-wrapper .ppc-nav-menu-role', function () {
                    ...
                    //go to url
                    window.location = '<?php echo admin_url('admin.php?page=pp-capabilities-nav-menus&role='); ?>' + $(this).val() + '';
