...
class CapabilityFilters
{
    ...
    function fltPostStatuses($statuses, $args) {
        ...
        //if (false !== strpos( urldecode($_SERVER['REQUEST_URI']), 'admin.php?page=rvy-moderation') && !empty($args['has_cap_check'])) {
        if (!empty($args['has_cap_check']) || !empty($_REQUEST['preview']) || 'revision.php' == $pagenow 
        ) {
