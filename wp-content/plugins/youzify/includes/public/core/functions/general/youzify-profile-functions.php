...
function youzify_user_quick_buttons( $user_id = false ) {
    ...
    <div class="youzify-quick-buttons">
        ...
        <?php if ( bp_is_active( 'messages' ) ) : ?>
            ...
            <a href="<?php echo bp_nav_menu_get_item_url( 'messages' ); ?>" class="youzify-button-item youzify-messages-btn">
        ...
        <?php if ( bp_is_active( 'notifications' ) ) : ?>
            ...
            <a href="<?php echo bp_nav_menu_get_item_url( 'notifications' ); ?>" class="youzify-button-item youzify-notification-btn">
...
function youzify_user_account_avatar() {
    ...
    <div class="youzify-primary-nav-area">
        ...
        <div class="youzify-primary-nav-settings">
            ...
            <span><?php echo apply_filters( 'youzify_account_avatar_shortcode_username', bp_core_get_username( $user_id ), $user_id ); ?></span>
    ...
    <div class="youzify-media youzify-media-box" style="display: none;">
        ...
        <div class="youzify-media-filter">
            ...
            <div class="youzify-filter-item" style="width:<?php echo 100 / $count; ?>%;">
                <div class="youzify-filter-content<?php if ( $filter['type'] == $default_type ) echo ' youzify-current-filter'; ?>" <?php if ( isset( $args['user_id'] ) ) $filter['user_id'] = $args['user_id']; if ( isset( $args['group_id'] ) ) $filter['group_id'] = $args['group_id']; echo youzify_get_tag_attributes( $filter ); ?> ><i class="<?php echo $filter['icon']; ?>"></i><span><?php echo $filter['title']; ?></span></div>
            </div>
            <?php endforeach; ?>
        </div>
        <?php endif; ?>
        <div class="youzify-media-widget youzify-media-<?php echo $args['box']; ?>-box">
            <div class="youzify-media-group-<?php echo $default_type; ?>" data-active="true">
                ...
                <a class="youzify-media-view-all" href="<?php echo $media->get_media_by_type_slug( $args ); ?>"><?php echo sprintf( __( 'View All %1s ( %2d )', 'youzify' ), $available_filters[ $default_type ]['title'], $total ); ?></a>
                <?php endif; ?>
                </div>
