...
class Youzify_Wall {
		...
		if ( ! empty( $attachments ) ) {
			...
			switch ( $type ) {
				...
				case 'image':
					...
					?>
					<a href="<?php echo $item_url; ?>" rel="nofollow" class="youzify-img-with-padding" data-youzify-lightbox="youzify-post-<?php echo $comment_id; ?>"><img loading="lazy" <?php echo youzify_get_image_attributes( $attachment_id, 'youzify-comment', 'activity-comment' ); ?> alt=""></a>
					<?php
					break;
	...
	function get_wall_post_giphy( $activity_id ) {
		...
		?>
		<a href="<?php echo $img_url; ?>" rel="nofollow" class="youzify-img-with-padding" data-youzify-lightbox="youzify-post-<?php echo $activity_id; ?>"><img loading="lazy" <?php echo youzify_get_image_attributes_by_link( $img_url ); ?> alt=""></a>
		<?php
	...
	function get_wall_post_link( $attachments, $activity_id ) {
		...
		<a class="youzify-wall-link-content" rel="nofollow" href="<?php echo $link_url; ?>" target="_blank">
	...
	function get_activity_url_preview( $activity_id, $activity_content = null ) {
		...
		<a class="youzify-wall-link-content" rel="nofollow" href="<?php echo $url['link']; ?>" target="_blank">
	...
	function show_url_preview( $data, $activity_content = null ) {
		...
		return apply_filters( 'youzify_display_activity_live_url_preview', $show );
	}
	...
	function get_wall_post_images( $attachments, $activity_id ) {
		...
		if ( 1 == $count_atts ) {
			...
			<a href="<?php echo wp_get_attachment_image_url( $media_id, 'full' ); ?>" rel="nofollow" class="youzify-img-with-padding" data-youzify-lightbox="youzify-post-<?php echo $activity_id; ?>"><img loading="lazy" <?php echo youzify_get_image_attributes( $media_id, 'youzify-wide', 'activity-photo' ); ?> alt=""></a>
			...
			<div class="youzify-post-<?php echo $count_atts; ?>imgs">
				...
				<?php $n = 0; foreach( $attachments as $media_id => $data ) : $n++;?>
					<a class="youzify-post-img<?php echo $n;?>" rel="nofollow" href="<?php echo wp_get_attachment_image_url( $media_id, 'full' ); ?>" data-youzify-lightbox="youzify-post-<?php echo $activity_id; ?>">
		...
		<?php } elseif ( 4 <= $count_atts ) { ?>
			...
			<div class="youzify-post-4imgs">
				...
				<a class="youzify-post-img<?php echo $i + 1; if ( 3 == $i && $count_atts > 4  ) { echo ' youzify-post-plus4imgs'; }?>" href="<?php echo wp_get_attachment_image_url( $media_id, 'full' ); ?>" rel="nofollow" data-youzify-lightbox="youzify-post-<?php echo $activity_id; ?>">
	...
	function embed_group( $group_id = false ) {
		...
		?>
	 	...
	 	<div class="youzify-wall-embed youzify-wall-embed-group">
	 		...
	 		<a href="<?php echo $group_url; ?>" class="youzify-embed-avatar"><?php echo bp_core_fetch_avatar( array( 'item_id' => $group_id, 'type' => 'full', 'html' => true, 'object' => 'group' ) ); ?></a>
	 		<div class="youzify-embed-data">
	 			<div class="youzify-embed-head">
		 			<a href="<?php echo $group_url; ?>" class="youzify-embed-name"><?php echo $group->name; ?></a>
	...
	function embed_user( $user_id = false ) {
		...
		?>
	 	...
	 	<div class="youzify-wall-embed youzify-wall-embed-user">
	 		...
	 		<a href="<?php echo $profile_url; ?>" class="youzify-embed-avatar"><?php echo bp_core_fetch_avatar(
			array( 'item_id' => $user_id, 'type' => 'full', 'html' => true ) ); ?></a>
	 		<div class="youzify-embed-data">
	 			<div class="youzify-embed-head">
		 			<a href="<?php echo $profile_url; ?>" class="youzify-embed-name"><?php echo bp_core_get_user_displayname( $user_id ); ?></a>
		 			<div class="youzify-embed-meta">@<?php echo bp_core_get_username( $user_id ); ?></div>
	 			</div>
	 			<div class="youzify-embed-action">
	...
	function embed_post( $blog_id = false, $post_id = false ) {
		...
		?>
	 	...
	 	<div class="youzify-wall-new-post">
	 		<div class="youzify-post-img"><a href="<?php echo $post_link; ?>"><?php echo $post_tumbnail; ?></a></div>
	 		...
	 		<div class="youzify-post-inner">
		 		...
		 		<div class="youzify-post-head">
		 			<div class="youzify-post-title"><a href="<?php echo $post_link; ?>"><?php echo $post->post_title; ?></a></div>
		 		...
		 		<a href="<?php echo $post_link; ?>" class="youzify-post-more-button"><span class="youzify-btn-icon"><i class="fas fa-angle-double-right"></i></span><span class="youzify-btn-title"><?php echo apply_filters( 'youzify_wall_embed_blog_post_read_more_button', __( 'Read More', 'youzify' ) ); ?></span></a>
	 		</div>
	 	</div>
