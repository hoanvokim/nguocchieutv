...
function youzify_gamipress_get_badges_more_button( $user_id = null, $badges_nbr = null, $max_badges = null, $more_type = 'box' ) {
    ...
    if ( $badges_nbr > $max_badges ) :
        ...
        <div class="youzify-badge-item youzify-more-items youzify-user-badges-more-<?php echo $more_type ?>" <?php if ( 'box' == $more_type ) echo 'data-youzify-tooltip="' . __( 'Show All Badges', 'youzify' )  . '"'; ?>><a href="<?php echo bp_core_get_user_domain( $user_id ) . youzify_gamipress_badges_slug();?>"><?php echo $more_title; ?></a></div>
    <?php endif;
