...
global $row_cols_md_counter_inner, $row_cols_sm_counter_inner, $inner_column_style, $front_background_colors, $previous_blend, $is_cb, $changer_back_color_column, $changer_back_color_row_inner, $changer_back_color_column_inner;
...
if ( empty($back_color) && $changer_back_color_column ) {
	$changer_back_color_row_inner = true;
} else {
...
$uncode_row_child = $uncode_row_parent = 120;
